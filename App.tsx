...
export default function App() {
  ...
  const [status, setStatus] =
    useState("Ready · backend not connected");
  ...
  function handleGenerate() {
    ...
    /*
      ...
      When the backend exists, this lock stays
      active until the server reports:
      ...
      The server will enforce the real
      anti-spam/queue limits.
    */
